import { ArgsTable, Canvas, Meta, Story, Subtitle } from "@storybook/addon-docs";
import { RouteAnnouncer } from "../../src/components/announcer/route-announcer";
import { DemoWithRouter } from "./route";

<Meta title="Feedback/Route Announcer" component={RouteAnnouncer} />
...
- Click on "Blog" to show the first page. _(This is a constraint of using a router inside Storybook)._
