...
import { images } from "../../cypress/test/components/keyboard-only/mocks/AuditInPage";
...
.w3-modal{z-index:3;display:none;padding-top:100px;position:sticky;left:0;top:0;width:100%;height:100%;overflow:auto;background-color:rgb(0,0,0);background-color:rgba(0,0,0,0.4)}
...
.w3-top,.w3-bottom{position:sticky;width:100%;z-index:1}.w3-top{top:0}.w3-bottom{bottom:0}
.w3-overlay{position:sticky;display:none;width:100%;height:100%;top:0;left:0;right:0;bottom:0;background-color:rgba(0,0,0,0.5);z-index:2}
	...
	return (
		<Styles.Layout>
			...
			<Styles.Menu
				...
				style={{ display: isOpen ? "block" : "none", zIndex: 2, width: "40%", minWidth: "300px" }}
				id="mySidebar"
			>
				<button type="button" onClick={() => setIsOpen(false)} className="w3-bar-item w3-button">
					Close Menu
				</button>
				<a href="#food" onClick={() => setIsOpen(false)} className="w3-bar-item w3-button">
					Food
				</a>
				<a href="#about" onClick={() => setIsOpen(false)} className="w3-bar-item w3-button">
					About
				</a>
			</Styles.Menu>
			<div className="w3-top">
				<div className="w3-white w3-xlarge" style={{ maxWidth: "1200px", margin: "auto" }}>
					...
					<Styles.Button
						...
						className="w3-right w3-padding-16"
					>
				...
				<footer className="w3-row-padding w3-padding-32">
					...
					<div className="w3-third w3-serif">
						...
						<p>
							...
							<span className="w3-tag w3-dark-grey w3-small w3-margin-bottom">Salmon</span> <span className="w3-tag w3-dark-grey w3-small w3-margin-bottom">
								France
							</span> <span className="w3-tag w3-dark-grey w3-small w3-margin-bottom">Drinks</span>
							...
							<span className="w3-tag w3-dark-grey w3-small w3-margin-bottom">Chicken</span> <span className="w3-tag w3-dark-grey w3-small w3-margin-bottom">
								Dressing
							</span> <span className="w3-tag w3-dark-grey w3-small w3-margin-bottom">Fried</span>
...
- Check if this (shamelessly stolen) demo from the W3Schools is accessible. (Spoiler alert: It's not 😀)
- Can you press `tab` and navigate through the interface?
- Can you open the menu and close it?

<Canvas>
	<Story name="Keyboard Only">
		<AuditInPage />
	</Story>
</Canvas>
...
Note: _Of course, before committing or releasing to production, remove the component from the DOM._ 😉
